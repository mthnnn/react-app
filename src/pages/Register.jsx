                  ...
                  <div className="mb-3">
                    ...
                    <div className={`card card-body border ${cardColor}`}>
                      <div className="form-check">
                        <input //bu bloğa yazdığımız hobi türlerimzin görünür olması için cardColoru kullanıyoruz, Logindeki gibi
                          type="checkbox" //bu bloğa card-body border classını ekliyoruz otomatik bi padding bilgisi olabilmesi için
                          name="hobbies"
                          id="cars"
